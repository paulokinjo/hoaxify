...
describe('Layout', () => {
  ...
  it('displays the label provided in pros', () => {
  ...
  it('displays placeholder for input when it is provided as props', () => {
    const { container } = render(<Input placeholder="Test placeholder" />);
    const input = container.querySelector('input');
    expect(input.placeholder).toBe('Test placeholder');
  });

  it('displays value for input when it is provided as props', () => {
